...
function App() {
  ...
  const [availableCards, setAvailableCards] = useState([
    ...
    {
      id: 21,
      name: "PoliticalSalesVsPurchases",
    ...
    {
      id: 22,
      name: "TopPoliticalInsiders",
      title: "Top Political Insiders",
      info: "This card shows the top insiders ranked by volume. The volume is an approximation as exact amounts are not specified in their disclosures, only ranges. Politicians often make legislation that they believe will affect the stock market, and are unrestricted to trading in the stock market. Monitoring their transactions may be valuable to some.",
      infoVisible: false,
      x: 3,
      y: 2,
      w: 3,
